...
def test_pipeline_imports_cep_lookup():
    """Verify that the pipeline module imports and uses lookup_cep for CEP enrichment."""
    from src import pipeline

    assert hasattr(pipeline, "lookup_cep"), (
        "pipeline should import lookup_cep from cep_client"
    )
